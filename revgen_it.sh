...
echo ""
echo "Questo script genera una reverse shell in diversi linguaggi"
echo ""
echo "##################By Simone Mallia#########################"
echo ""
$yellow; echo "Inserisci l'indirizzo ip"; $reset
read ip
$bold; $yellow; echo "Inserisci la porta"; $reset
read port
$bold; $yellow; echo "Genera la reverse shell in:"; $reset
...
while true; do
	...
	;;
	*)
	$bold; $cyan; echo "Scelta non corretta. Ritenta"; $reset;;
	esac
done
